...
@Preview
fun App() {
    var backstack = remember { Stack<Pair<Screens, String>>() }//stack
    ...
    Scaffold(//divide screen in 3 parts
        topBar = {
            TopAppBar(
        ...
        AnimatedContent(
            ...
            when (targetScreen.first) {//switch case
...
fun main() = application {// kotlin compose
    Window(onCloseRequest = ::exitApplication) {//create blank box
        App()
    }
}